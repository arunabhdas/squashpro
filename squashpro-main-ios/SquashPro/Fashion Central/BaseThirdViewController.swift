...
class BaseThirdViewController: UIViewController {
    ...
    var players = ["Kyle", "Das", "Mark", "Trish", "Adam", "Andrew", "Breanne", "Deanna", "Fielding", "Harjeet", "Jon", "Maria", "Philips", "Spencer", "Courtney"]
    ...
    override func viewDidLoad() {
        ...
        reloadBarButtonItem = UIBarButtonItem(title: Constants.ThirdViewController.kBrowseTitle, style: .plain, target: self, action: #selector(reloadButtonAction))
        ...
        constrain(swipeableView, view) { view1, view2 in
            ...
            view1.top == view2.top + 60
            view1.bottom == view2.bottom - 160
        }
    }
    ...
    */
    ...
    func nextCardView() -> UIView? {
        ...
        let cardView = RKCardView(frame: swipeableView.bounds)
        cardView.profileImageView.image = UIImage(named: "cat")
        cardView.coverImageView.image = UIImage(named: "Icon")
        
        let topImageView = UIImageView(frame: CGRect(x: 0, y: 0, width: 360.0, height: 200.0))
        cardView.addSubview(topImageView)
        
        // let innerCardView = CardView(frame: CGRectMake(20, 200, 320.0, 120.0))
        // innerCardView.contentView = UIImageView(image:UIImage(named: "sample_2"))
        // cardView.addSubview(innerCardView)
        
        cardView.titleLabel.text = players[playerIndex]
        cardView.titleLabel.textColor = UIColor.white
        cardView.backgroundColor = colorForName(colors[colorIndex])
