...
extension RightMenuViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let titles: [String] = ["League", "Practice", "Logout"]
        ...
        case 0:
            cell.imageView?.image = UIImage.fontAwesomeIconWithName(.User, textColor: UIColor.whiteColor(), size: CGSizeMake(30, 30))
            break;
        case 1:
            cell.imageView?.image = UIImage.fontAwesomeIconWithName(.SignOut, textColor: UIColor.whiteColor(), size: CGSizeMake(30, 30))
            break;
        default:
            break;
        }
