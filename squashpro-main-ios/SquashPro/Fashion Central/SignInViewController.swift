...
protocol SignInCompletionPresentedViewControllerDelegate {
...
class SignInViewController: BaseViewController, UIGestureRecognizerDelegate  {
    ...
    var loginMainViewController: LoginMainViewController?
    ...
    override func setupUI() {
        ...
        let upload = Label.str("Stay on top of your progress on the squash court.").color("white").font(20).lines(3).align(.center)
        ...
        login.addTarget(self, action: #selector(SignInViewController.handleSignIn), for: .touchUpInside)
        signup.addTarget(self, action: #selector(SignInViewController.handleSignUp), for: .touchUpInside)
        tour.addTarget(self, action: #selector(SignInViewController.handleOnboarding), for: .touchUpInside)
    ...
    func handleSignIn() {
        ...
        loginMainViewController = storyboard.instantiateViewController(withIdentifier: "LoginMainViewController") as? LoginMainViewController
        self.present(loginMainViewController!, animated: true, completion: nil)
    }
