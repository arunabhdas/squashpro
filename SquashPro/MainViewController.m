...
@property (nonatomic, strong) EmptyViewController *rightPanelViewController;
...
- (void)resetMainView {
    ...
    if (_leftPanelViewController != nil)
    {
        ...
        _centerViewController.leftNavButton.tag = 1;
...
- (UIView *)getRightView {
    ...
    if (_rightPanelViewController == nil)
    {
        ...
        self.rightPanelViewController = [[EmptyViewController alloc] init];
...
-(void)movePanel:(id)sender {
    ...
    if([(UIPanGestureRecognizer*)sender state] == UIGestureRecognizerStateChanged) {
        if(velocity.x > 0) {
            ...
            NSLog(@"gesture went left");
            _showPanel = abs([sender view].center.x - _centerViewController.view.frame.size.width/1.5) > _centerViewController.view.frame.size.width/1.5;
        }
    ...
    [UIView animateWithDuration:SLIDE_TIMING delay:0 options:UIViewAnimationOptionBeginFromCurrentState
                     ...
                     completion:^(BOOL finished) {
                         if (finished) {
                             ...
                             _centerViewController.leftNavButton.tag = 0;
                         }
                     }];
}
