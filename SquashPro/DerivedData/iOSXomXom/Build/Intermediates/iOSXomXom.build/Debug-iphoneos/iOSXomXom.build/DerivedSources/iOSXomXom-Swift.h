...
@interface UIColor (SWIFT_EXTENSION(iOSXomXom))
...
- (instancetype)initWithHexString:(NSString *)hexString alpha:(float)alpha;
...
- (instancetype)initWithHex:(NSInteger)hex alpha:(float)alpha;
@end
